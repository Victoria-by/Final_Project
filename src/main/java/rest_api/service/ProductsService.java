...
import static functional.util.PropertiesReader.getEndPoint;

public class ProductsService {

    @Step("Get products")
    public List<Product> getProducts() {
        return getObjectsByJsonPath(makeRequestAndGetResponseBody(getEndPoint("endPoint"), null, null),
    ...
    public List<String> getNamePrefixes() {
        ...
        return getListStringByJsonPath(makeRequestAndGetResponseBody(getEndPoint("endPoint"), null, params),
